...
user3 = User.new(email: "user3@abc.com", password: "123456789", first_name: Faker::Name.name, last_name: Faker::Name.last_name, phone_number: 12345678)
user3.photo.attach(io: fileavatar3, filename: 'testavatar3.png', content_type: 'image/png')
user3.save

user4 = User.new(email: "user4@abc.com", password: "123456789", first_name: Faker::Name.name, last_name: Faker::Name.last_name, phone_number: 1234567890)
user4.photo.attach(io: fileavatar4, filename: 'testavatar2.png', content_type: 'image/png')
user4.save

user5 = User.new(email: "user5@abc.com", password: "123456789", first_name: Faker::Name.name, last_name: Faker::Name.last_name, phone_number: 1234567890)
user5.photo.attach(io: fileavatar5, filename: 'testavatar2.png', content_type: 'image/png')
user5.save

user6 = User.new(email: "user6@abc.com", password: "123456789", first_name: Faker::Name.name, last_name: Faker::Name.last_name, phone_number: 1234567890)
user6.photo.attach(io: fileavatar6, filename: 'testavatar2.png', content_type: 'image/png')
user6.save

user7 = User.new(email: "user7@abc.com", password: "123456789", first_name: Faker::Name.name, last_name: Faker::Name.last_name, phone_number: 1234567890)
user7.photo.attach(io: fileavatar7, filename: 'testavatar2.png', content_type: 'image/png')
user7.save

user8 = User.new(email: "user8@abc.com", password: "123456789", first_name: Faker::Name.name, last_name: Faker::Name.last_name, phone_number: 1234567890)
...
# #existir
 service3 = Service.new(start_time: Faker::Time.forward(days: 5,  period: :evening, format: :long), duration: 1, place: "Buenos Aires", price: 800, user: user3, plan: "Me encanta meditar y sentirme en paz, conectar con otros a nivel personal, soy padre de 2 hijos" )
 service3.photo.attach(io: file_service3, filename: 'test2.png', content_type: 'image/png')
 service3.save

# #pasear a tu perro
 service4 = Service.new(start_time: Faker::Time.forward(days: 5,  period: :evening, format: :long), duration: 1, place: "Bogota", price: 950, user: user4, plan: "Me encantan los animales, tengo 2 gatos y un perro, soy veterinario desde hace mas de 10 años" )
 service4.photo.attach(io: file_service4, filename: 'test2.png', content_type: 'image/png')
 service4.save

# #tomar café
 service5 = Service.new(start_time: Faker::Time.forward(days: 5,  period: :evening, format: :long), duration: 1, place: "Bogota", price: 700, user: user5, plan: "Soy barista, disfruto mucho la compañia de otros, socializar, ir de fiesta.." )
 service5.photo.attach(io: file_service5, filename: 'test2.png', content_type: 'image/png')
 service5.save

# #cena con tu familia
 service6 = Service.new(start_time: Faker::Time.forward(days: 5,  period: :evening, format: :long), duration: 1, place: "Cordoba", price: 650, user: user6, plan: "Me desempeño como terapeuta hace muchos años, busco poder compartir con tu circulo social" )
 service6.photo.attach(io: file_service6, filename: 'test2.png', content_type: 'image/png')
 service6.save

# #correr
 service7 = Service.new(start_time: Faker::Time.forward(days: 5,  period: :evening, format: :long), duration: 2, place: "Cordoba", price: 850, user: user7, plan: "Amo el deporte! en especial correr y hacer trekking, prefiero practicar deporte con otros" )
 service7.photo.attach(io: file_service7, filename: 'test2.png', content_type: 'image/png')
 service7.save

# #al museo
service8 = Service.new(start_time: Faker::Time.forward(days: 5,  period: :evening, format: :long), duration: 2, place: "Cordoba", price: 800, user: user8, plan: "Mis cosas favoritas son la poesia, los libros, el arte. Prefiero hablar de temas culturales" )
service8.photo.attach(io: file_service8, filename: 'test2.png', content_type: 'image/png')
service8.save

# #a estudiar
 service9 = Service.new(start_time: Faker::Time.forward(days: 5,  period: :evening, format: :long), duration: 3, place: "Rosario", price: 1000, user: user9, plan: "Soy docente, trato de ayudar a que las personas aprenden de la forma mas facil posible" )
